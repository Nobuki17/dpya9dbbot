...
async def on_message(message):
    ...
    if bot.user in message.mentions:
        ...
        embed.add_field(name="初期状態:", value="マシンランク:467\n<:topspeed:731079571050594304>最高速度:250.0\n<:acceleration:731080263357956137>加速:42.40\nハンドリング:46.30\nニトロ:54.80",inline=False)
        embed.add_field(name="☆1 MAX:", value="マシンランク:791\n<:topspeed:731079571050594304>最高速度:257.2\n<:acceleration:731080263357956137>加速:46.89\nハンドリング:48.96\nニトロ:59.59")
        embed.add_field(name="☆2 MAX:", value="マシンランク:1,094\n<:topspeed:731079571050594304>最高速度:263.9\n<:acceleration:731080263357956137>加速:51.08\nハンドリング:51.44\nニトロ:64.03")
        embed.add_field(name="☆3 MAX:", value="マシンランク:1,381\n<:topspeed:731079571050594304>最高速度:270.1\n<:acceleration:731080263357956137>加速:55.03\nハンドリング:53.79\nニトロ:68.19")
        ...
        embed.add_field(name="レア度:", value="アンコモン")
        embed.add_field(name="給油時間:", value="05m00s(<:switch:726284432234774600>02m00s)")
        embed.add_field(name="初期状態:", value="マシンランク:518\n<:topspeed:731079571050594304>最高速度:250.0\n<:acceleration:731080263357956137>加速:58.60\nハンドリング:39.02\nニトロ:45.09",inline=False)
        embed.add_field(name="☆1 MAX:", value="マシンランク:859\n<:topspeed:731079571050594304>最高速度:256.0\n<:acceleration:731080263357956137>加速:62.24\nハンドリング:42.00\nニトロ:49.49")
        embed.add_field(name="☆2 MAX:", value="マシンランク:1,172\n<:topspeed:731079571050594304>最高速度:261.5\n<:acceleration:731080263357956137>加速:65.64\nハンドリング:44.79\nニトロ:53.91")
        embed.add_field(name="☆3 MAX:", value="マシンランク:1,476\n<:topspeed:731079571050594304>最高速度:266.8\n<:acceleration:731080263357956137>加速:68.86\nハンドリング:47.43\nニトロ:57.49")
        ...
        embed.add_field(name="レア度:", value="アンコモン")
        embed.add_field(name="給油時間:", value="05m00s(<:switch:726284432234774600>02m00s)")
        embed.add_field(name="初期状態:", value="マシンランク:556\n<:topspeed:731079571050594304>最高速度:265.0\n<:acceleration:731080263357956137>加速:51.40\nハンドリング:41.17\nニトロ:48.53",inline=False)
        embed.add_field(name="☆1 MAX:", value="マシンランク:910\n<:topspeed:731079571050594304>最高速度:271.8\n<:acceleration:731080263357956137>加速:56.19\nハンドリング:43.75\nニトロ:53.78")
        embed.add_field(name="☆2 MAX:", value="マシンランク:1,232\n<:topspeed:731079571050594304>最高速度:278.9\n<:acceleration:731080263357956137>加速:60.63\nハンドリング:46.13\nニトロ:58.68")
        embed.add_field(name="☆3 MAX:", value="マシンランク:1,546\n<:topspeed:731079571050594304>最高速度:284.1\n<:acceleration:731080263357956137>加速:64.81\nハンドリング:48.39\nニトロ:63.29")
        embed.set_footer(text="最終更新:2020 07/05")
        await message.channel.send(embed=embed)
        ...
        embed.add_field(name="初期状態:", value="マシンランク:799\n<:topspeed:731079571050594304>最高速度:292.0\n<:acceleration:731080263357956137>加速:64.00\nハンドリング:26.47\nニトロ:23.08",inline=False)
        embed.add_field(name="☆1 MAX:", value="マシンランク:1,077\n<:topspeed:731079571050594304>最高速度:297.5\n<:acceleration:731080263357956137>加速:66.40\nハンドリング:29.96\nニトロ:30.34")
        embed.add_field(name="☆2 MAX:", value="マシンランク:1,425\n<:topspeed:731079571050594304>最高速度:No Data\n<:acceleration:731080263357956137>加速:No Data\nハンドリング:No Data\nニトロ:No Data")
        embed.add_field(name="☆3 MAX:", value="マシンランク:1,687\n<:topspeed:731079571050594304>最高速度:308.6\n<:acceleration:731080263357956137>加速:71.92\nハンドリング:37.98\nニトロ:45.41")
        ...
        embed.add_field(name="初期状態:", value="マシンランク:1,970\n<:topspeed:731079571050594304>最高速度:328.0\n<:acceleration:731080263357956137>加速:73.00\nハンドリング:39.63\nニトロ:50.33")
        embed.add_field(name="☆1 MAX:", value="マシンランク:2,205\n<:topspeed:731079571050594304>最高速度:331.5\n<:acceleration:731080263357956137>加速:74.30\nハンドリング:41.49\nニトロ:53.61")
        embed.add_field(name="☆2 MAX:", value="マシンランク:2,452\n<:topspeed:731079571050594304>最高速度:335.1\n<:acceleration:731080263357956137>加速:75.67\nハンドリング:43.44\nニトロ:57.07")
        embed.add_field(name="☆3 MAX:", value="マシンランク:2,736\n<:topspeed:731079571050594304>最高速度:339.2\n<:acceleration:731080263357956137>加速:77.29\nハンドリング:45.75\nニトロ:60.85")
        embed.add_field(name="☆4 MAX:", value="マシンランク:3,012\n<:topspeed:731079571050594304>最高速度:343.5\n<:acceleration:731080263357956137>加速:78.70\nハンドリング:47.80\nニトロ:64.79")
        embed.set_footer(text="最終更新:2020 07/10")
        await message.channel.send(embed=embed)
